...
export const Buildings: Array<Building> = [
  {
    ...
    category: [Category.ArtesYCiencias],
  ...
  },
  {
    ...
    abbreviation: "AE",
    category: [Category.AdministracionDeEmpresas],
    short_description: "Departamento de Ingenieria Electrica y de Computadoras",
    long_description: "",
    coordinates: [0,0],
    image: '../../assets/img/edificios/edificio_stefani.jpg'
  },
  {
    ...
    category: [Category.DecanatoDeEstudiantes],
  ...
  },
  {
    ...
    abbreviation: "P",
    category: [Category.CienciasAgricolas],
    short_description: "Departamento de Ingenieria Electrica y de Computadoras",
    long_description: "",
    coordinates: [0,0],
    image: '../../assets/img/edificios/edificio_stefani.jpg'
